  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-foreground">Gestion des Fournisseurs</h2>
          <p className="text-sm text-muted-foreground">Gérer vos partenaires et contacts fournisseurs</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card className="p-4">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-semibold text-green-600">{activeSuppliers}</p>
          </div>
        </Card>
        <Card className="p-4">
          <div className="space-y-1">
            <p className="text-sm text-muted-foreground">Fournisseurs filtrés</p>
            <p className="text-2xl font-semibold text-foreground">{filteredSuppliers.length}</p>
          </div>
        </Card>
      </div>
              ...
              <div className="p-6">
                ...
                {supplier.notes && (
                  <div className="mt-4 rounded-md bg-muted/50 p-3">
                    <p className="line-clamp-2 text-sm text-muted-foreground">{supplier.notes}</p>
                  </div>
                )}

                <div className="mt-4 flex items-center justify-between border-t border-border pt-4">
                  <div className="text-sm">
                    <span className="font-medium text-foreground">{articlesCount}</span>
      ...
      {filteredSuppliers.length === 0 && (
        <Card className="p-12">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-4 text-lg font-medium text-foreground">Aucun fournisseur trouvé</p>
...
function SupplierDialog({ open, onOpenChange, supplier, onSave }: SupplierDialogProps) {
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit">{supplier ? "Enregistrer" : "Créer"}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
